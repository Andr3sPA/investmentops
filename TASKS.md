...
- [ ] Crear la carpeta de prompts, separada del código Python, donde vivirá el prompt de cada agente como archivo independiente.
...
- Implementar al menos una integración concreta (por ejemplo, un proveedor) que cumpla la interfaz.
...
- Implementar manejo de error básico cuando el proveedor de IA no responde o devuelve un formato inesperado.
