...
agentes de salud financiera y valoración) y `assemble_research_result`
...
sobre el modelo normalizado" e "Implementar el ensamblado de ambos
resultados en un 'Resultado de investigación' único" (TASKS.md, Fase 1,
"Orquestador mínimo"). No prueba el manejo de fallos parciales: esa es
una tarea separada y posterior de la misma sección.
"""
